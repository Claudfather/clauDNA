...
Present summary: session, date, problem, platform, root causes, fix list, prevention recommendations, docs path. Direct user to run `/claudna:build` on the investigation directory.
