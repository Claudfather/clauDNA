...
Once the user picks a repo, suggest the relevant skill (`/claudna:session resume`, `/review-pr`, `/implement-plan`). If it's a different directory, tell the user to switch there first.
