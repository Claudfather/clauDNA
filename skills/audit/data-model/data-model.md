...
- For `docs`: author the full ranked findings report as a publishable doc in scratch, then `/claudna:publish <file> --to docs --dir documentation/planning/data-model/<session_name>_<YYYY-MM-DD>/`
