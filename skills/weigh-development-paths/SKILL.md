...
- For `docs`: author the full analysis as a publishable doc in scratch, then `/claudna:publish <file> --to docs --dir documentation/planning/decisions/<session_name>_<YYYY-MM-DD>/`
